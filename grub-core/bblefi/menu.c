...
grub_err_t loadmenu(bara_efi_ip_address_t* server_ip, grub_efi_mac_t* client_mac, const grub_uint16_t arch_type,
...
void header()
{
	...
	//grub_printf(" Version %s (GRUB %s)\n\n", g_version, PACKAGE_VERSION); // don't use this because in PACKAGE_VERSION is beta2
	grub_printf(" Version %s (GRUB 2.04)\n\n", g_version);
}
...
grub_err_t menu(bara_efi_ip_address_t* server_ip,
